...
exports.generateProposalEmail = exports.sendEmail = void 0;
    ...
    if (isDevelopment) {
        ...
        if (!process.env.ETHEREAL_USER || !process.env.ETHEREAL_PASS) {
            if (!etherealAccount) {
                ...
                etherealAccount = await nodemailer_1.default.createTestAccount();
...
const sendEmail = async (options) => {
    try {
        ...
        const rawPreview = nodemailer_1.default.getTestMessageUrl(info);
...
const generateProposalEmail = (leadData) => {
    const { name, niche, address, hasWebsiteIssue, senderName, senderEmail, senderSkill, } = leadData;
    const html = `
    <!DOCTYPE html>
    <html>
    <head>
...
exports.generateProposalEmail = generateProposalEmail;
